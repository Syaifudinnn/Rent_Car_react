            ...
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-24 mx-auto">
                    <div class="flex flex-col text-center w-full mb-20">
                        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">High Performance Car is Yours</h1>
                        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Apapun yang kamu butuhkan, di sini lah tempatnya. Mobil dengan performa tinggi dengan kualitas number one</p>
                    </div>
                        ...
                        <div class="lg:w-1/3 sm:w-1/2 p-4">
                            <div class="flex relative">
                                <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="https://dummyimage.com/600x360" />
                                    <div class="px-8 py-10 relative z-10 w-full border-4 border-blue-600 bg-white opacity-0 hover:opacity-100">
